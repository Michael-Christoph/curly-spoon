...
//extended version of BagOfWordGenerator (provided as open course material by Prof. Ludwig) which allows 
//the manipulation of the clustering parameters via the constructor.
public class BagOfWordsGenerator_mod {
	...
	public BagOfWordsGenerator_mod(){
		this(16,16);
	}

	//Standard-Config wie von Prof. Ludwig zur Verfügung gestellt.
	public BagOfWordsGenerator_mod(int cacheSize, int numWords){
		this(cacheSize,numWords,
				false, 100,
				10000, 2, -1.0, -1.25,500,
				false,1,false);
	}
	//flexibler Konstruktor für TestClusterParams.java
	public BagOfWordsGenerator_mod(int cacheSize, int numWords,
    	...
    	data = new Instances("TrainingInstances", atts, 1000);
	}
	...
	//Rückgabewert ggü BagOfWordGenerator.java von double[] zu int[] geändert,
	//da weniger Ressourcen und cast zu double auch später möglich.
